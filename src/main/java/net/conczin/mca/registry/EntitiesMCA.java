...
public interface EntitiesMCA {
        ...
        EntityType<ZombieVillagerEntityMCA> MALE_ZOMBIE_VILLAGER = register("male_zombie_villager", EntityType.Builder
                        .<ZombieVillagerEntityMCA>of((t, w) -> new ZombieVillagerEntityMCA(t, w, Gender.MALE),
                                        MobCategory.MONSTER)
                        .sized(0.6F, 2.0F), ZombieVillagerEntityMCA::createAttributes);
        EntityType<ZombieVillagerEntityMCA> FEMALE_ZOMBIE_VILLAGER = register("female_zombie_villager",
                        EntityType.Builder
                                        .<ZombieVillagerEntityMCA>of(
                                                        (t, w) -> new ZombieVillagerEntityMCA(t, w, Gender.FEMALE),
                                                        MobCategory.MONSTER)
                                        .sized(0.6F, 2.0F),
                        ZombieVillagerEntityMCA::createAttributes);
