...
public interface ItemsMCA {
        ...
        Item SIRBEN_BABY_GIRL = register("sirben_baby_girl",
                        new SirbenBabyItem(Gender.FEMALE, baseProps().stacksTo(1)));
        ...
        Item STAFF_OF_LIFE = register("staff_of_life",
                        new StaffOfLifeItem(baseProps().durability(10).rarity(Rarity.EPIC)));
        ...
        // 1.21.11: ToolMaterial.GOLD removed - SCYTHE item disabled
        ...
        Item POTION_OF_FEMININITY = register("potion_of_femininity",
                        new PotionOfMetamorphosisItem(baseProps().stacksTo(1), Gender.FEMALE));
        Item POTION_OF_MASCULINITY = register("potion_of_masculinity",
                        new PotionOfMetamorphosisItem(baseProps().stacksTo(1), Gender.MALE));
        ...
        Item BOOK_SUPPORTERS = register("book_supporters", new ExtendedWrittenBookItem(baseProps(), new Book(
                        "supporters")
                        ...
                        .addPage(new DynamicListPage("mca.books.supporters.contributors",
                                        page -> Supporters.getSupporterGroup("mca:contributors").stream().map(
                                                        s -> Component.literal(s).withStyle(ChatFormatting.DARK_GREEN))
                                                        .collect(Collectors.toList())))
                        .addPage(new DynamicListPage("mca.books.supporters.wiki",
                                        page -> Supporters.getSupporterGroup("mca:wiki").stream()
                                                        .map(s -> Component.literal(s).withStyle(ChatFormatting.GOLD))
                                                        .collect(Collectors.toList())))
                        .addPage(new DynamicListPage("mca.books.supporters.patrons",
                                        page -> Supporters.getSupporterGroup("mca:patrons").stream()
                                                        .map(s -> Component.literal(s).withStyle(ChatFormatting.RED))
                                                        .collect(Collectors.toList())))
                        .addPage(new DynamicListPage("mca.books.supporters.translators",
                                        page -> Supporters.getSupporterGroup("mca:translators").stream().map(
                                                        s -> Component.literal(s).withStyle(ChatFormatting.DARK_BLUE))
                                                        .collect(Collectors.toList())))
                        .addPage(new DynamicListPage("mca.books.supporters.old",
                                        page -> Supporters.getSupporterGroup("mca:old").stream()
                                                        .map(s -> Component.literal(s).withStyle(ChatFormatting.BLACK))
                                                        .collect(Collectors.toList())))
        ...
        Item BOOK_CULT_ANCIENT = register("book_cult_ancient", new ExtendedWrittenBookItem(baseProps(), new Book(
                        "cult_ancient")
                        .setBackground(MCA.locate("textures/gui/books/cult.png"))
                        .setTextFormatting(ChatFormatting.DARK_RED)
        ...
        Item GRAVELLING_HEADSTONE = register("gravelling_headstone",
                        new BlockItem(BlocksMCA.GRAVELLING_HEADSTONE, baseProps()));
        ...
        Item COBBLESTONE_UPRIGHT_HEADSTONE = register("cobblestone_upright_headstone",
                        new BlockItem(BlocksMCA.COBBLESTONE_UPRIGHT_HEADSTONE, baseProps()));
        Item COBBLESTONE_SLANTED_HEADSTONE = register("cobblestone_slanted_headstone",
                        new BlockItem(BlocksMCA.COBBLESTONE_SLANTED_HEADSTONE, baseProps()));
        Item WOODEN_UPRIGHT_HEADSTONE = register("wooden_upright_headstone",
                        new BlockItem(BlocksMCA.WOODEN_UPRIGHT_HEADSTONE, baseProps()));
        Item WOODEN_SLANTED_HEADSTONE = register("wooden_slanted_headstone",
                        new BlockItem(BlocksMCA.WOODEN_SLANTED_HEADSTONE, baseProps()));
        Item GOLDEN_UPRIGHT_HEADSTONE = register("golden_upright_headstone",
                        new BlockItem(BlocksMCA.GOLDEN_UPRIGHT_HEADSTONE, baseProps()));
        Item GOLDEN_SLANTED_HEADSTONE = register("golden_slanted_headstone",
                        new BlockItem(BlocksMCA.GOLDEN_SLANTED_HEADSTONE, baseProps()));
        Item DEEPSLATE_UPRIGHT_HEADSTONE = register("deepslate_upright_headstone",
                        new BlockItem(BlocksMCA.DEEPSLATE_UPRIGHT_HEADSTONE, baseProps()));
        Item DEEPSLATE_SLANTED_HEADSTONE = register("deepslate_slanted_headstone",
                        new BlockItem(BlocksMCA.DEEPSLATE_SLANTED_HEADSTONE, baseProps()));
        ...
        static List<CribItem> registerAllCribTypes() {
                ...
                for (CribWoodType wood : CribWoodType.values()) {
                        for (DyeColor color : DyeColor.values()) {
                                cribs.add((CribItem) register(
                                                color.getName() + "_" + wood.toString().toLowerCase(Locale.ROOT)
                                                                + "_crib",
                                                new CribItem(unstackableProps(), wood, color)));
                        }
                }
