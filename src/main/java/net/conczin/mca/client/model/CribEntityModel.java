...
/**
 * CribEntityModel - updated for 1.21.11 API
 * Now uses CribEntityRenderState instead of entity type parameter
 */
public class CribEntityModel<S extends CribEntityRenderState> extends EntityModel<S> {
    ...
    public static MeshDefinition getModelData(CubeDeformation dilation) {
        ...
        PartDefinition crib = data.addOrReplaceChild("Crib",
                CubeListBuilder.create().texOffs(0, 0).addBox(-9.0F, -5.0F, -13.0F, 19.0F, 2.0F, 25.0F, dilation),
        ...
        crib.addOrReplaceChild("Frame", CubeListBuilder.create()
                ...
                .texOffs(25, 27).mirror().addBox(-9.0F, -17.0F, -11.0F, 2.0F, 1.0F, 21.0F, dilation).mirror(false),
        ...
        crib.addOrReplaceChild("Legs", CubeListBuilder.create()
                ...
                .texOffs(0, 0).mirror().addBox(-9.0F, -17.0F, -13.0F, 2.0F, 12.0F, 2.0F, dilation).mirror(false),
                PartPose.offset(0.0F, 0.0F, 0.0F));
