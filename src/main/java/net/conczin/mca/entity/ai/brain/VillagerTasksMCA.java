...
public class VillagerTasksMCA {
        ...
        public static final ImmutableList<SensorType<? extends Sensor<? super Villager>>> SENSOR_TYPES = ImmutableList
                        .of(
        ...
        public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super VillagerEntityMCA>>> getImportantCorePackage(
                ...
                return ImmutableList.of(
                                ...
                                Pair.of(10, new ExtendedFindPointOfInterestTask(
                                                ...
                                                MemoryModuleType.HOME, false, Optional.of((byte) 14), (villager) -> {
                                                        ...
                                                        VillageManager manager = VillageManager
                                                                        .get((ServerLevel) entity.level());
                                                        if (entity.requiresHome()) {
                                                                return manager.findNearestVillage(entity)
                                                                                .filter(v -> !v.isPositionValidBed(pos))
                                                                                .isEmpty();
                                                        } else {
                                                                // villagers without the need of a home may only settle
                                                                // in inns
                                                                return manager.findNearestVillage(entity)
                                ...
                                Pair.of(10, new ExtendedFindPointOfInterestTask(
                                                ...
                                                MemoryModuleType.HOME, false, Optional.of((byte) 14), (villager) -> {
                                                        ...
                                                        return manager.findNearestVillage(entity).filter(v -> {
                                                                return v.getBuildingAt(pos).filter(
                                                                                b -> b.getBuildingType().noBeds())
                                                                                .isPresent();
                                                        }).isEmpty();
                                                })),
                                Pair.of(10, new ExtendedFindPointOfInterestTask(
                                                ...
                                                (villager) -> {
                                                        ...
                                                        villager.getBrain()
                                                                        .getMemoryInternal(
                                                                                        MemoryModuleType.MEETING_POINT)
                                                                        .ifPresent(p -> {
                                                                                if (villager.level().dimension() == p
                                                                                                .dimension()) {
                                                                                        VillageManager manager = VillageManager
                                                                                                        .get((ServerLevel) villager
                                                                                                                        .level());
                                                                                        if (!manager.cache.contains(
                                                                                                        p.pos())) {
                                                                                                manager.cache.add(p
                                                                                                                .pos());
                                                                                                manager.processBuilding(
                                                                                                                p.pos());
                                                                                        }
        ...
        public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super VillagerEntityMCA>>> getWorkingCorePackage(
                ...
                return ImmutableList.of(
                                Pair.of(0, ValidateNearbyPoi.create(profession.heldJobSite(),
                                                MemoryModuleType.JOB_SITE)),
                                Pair.of(0,
                                                ValidateNearbyPoi.create(profession.acquirableJobSite(),
                                                                MemoryModuleType.POTENTIAL_JOB_SITE)),
                                Pair.of(2, PoiCompetitorScan.create()),
                                Pair.of(3, new LookAndFollowTradingPlayerSink(speedModifier)),
                                Pair.of(6,
                                                LazyFindPointOfInterestTask.create(profession.acquirableJobSite(),
                                                                MemoryModuleType.JOB_SITE,
                                                                MemoryModuleType.POTENTIAL_JOB_SITE, true,
                                                                Optional.empty())),
                                ...
                                Pair.of(0,
                                                new SayTask("villager.retreat", 100,
                                                                e -> VillagerTasksMCA.guardTooHurt(e)
                                                                                && e.getVillagerBrain().isPanicking())),
                                Pair.of(0,
                                                new SayTask("villager.attack", 160,
                                                                e -> !VillagerTasksMCA.guardTooHurt(e)
                                                                                && VillagerTasksMCA
                                                                                                .getPreferredTarget(e)
                                                                                                .isPresent())),
                                // self-defence while fleeing
                                Pair.of(0, new ConditionalTask<>(
                                                new ExtendedMeleeAttackTask(15, 2.5F, MemoryModuleType.NEAREST_HOSTILE),
                                                VillagerTasksMCA::guardTooHurt)),
                                Pair.of(1, new EquipmentTask(VillagerTasksMCA::isOnDuty, v -> v.getResidency()
                                                .getHomeVillage()
                                                .map(vil -> vil.getVillageGuardsManager().getGuardEquipment(
                                                                v.getProfession(),
                                                                v.getDominantHand()))
                ...
                if (guardTooHurt(villager)) {
                        ...
                        if (primary.isPresent()
                                        && (getActivity(villager) != Activity.REST
                                                        || primary.get().distanceTo(villager) < 8.0)) {
                                return primary;
                        } else {
                ...
                return ImmutableList.of(
                                Pair.of(0, new SequenceTask<>(
                                                ...
                                                ImmutableList.of(
                                                                ...
                                                                new DoNothing(100, 300),
                                                                new SayTask("villager.grieving"),
                                                                new HoldItemTask(InteractionHand.MAIN_HAND,
                                                                                ItemStack.EMPTY),
                                                                new LambdaTask<>((v) -> {
                ...
                return ImmutableList.of(
                                ...
                                Pair.of(5, new RunOne<>(
                                                ImmutableList.of(Pair.of(villagerWorkTask, 7),
                                                                Pair.of(StrollAroundPoi.create(
                                                                                MemoryModuleType.JOB_SITE, 0.4F, 4), 2),
                                                                Pair.of(StrollToPoi.create(MemoryModuleType.JOB_SITE,
                                                                                0.4F, 1, 10), 5),
                                                                Pair.of(StrollToPoiList.create(
                                                                                MemoryModuleType.SECONDARY_JOB_SITE,
                                                                                speedModifier, 1, 6,
                                ...
                                Pair.of(2, SetWalkTargetFromBlockMemory.create(MemoryModuleType.JOB_SITE, speedModifier,
                                                9, 100, 1200)),
        ...
        public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super VillagerEntityMCA>>> getPlayPackage(
                ...
                return ImmutableList.of(
                                ...
                                Pair.of(5, new RunOne<>(
                                                ImmutableMap.of(MemoryModuleType.VISIBLE_VILLAGER_BABIES,
                                                                MemoryStatus.VALUE_ABSENT),
                                                ImmutableList.of(
                                                                Pair.of(InteractWith.of(EntityType.VILLAGER, 8,
                                                                                MemoryModuleType.INTERACTION_TARGET,
                                                                                speedModifier, 2), 2),
                                                                Pair.of(InteractWith.of(EntityType.CAT, 8,
                                                                                MemoryModuleType.INTERACTION_TARGET,
                                                                                speedModifier, 2), 1),
                                                                Pair.of(VillageBoundRandomStroll.create(speedModifier),
                                                                                1),
                                                                Pair.of(SetWalkTargetFromLookTarget
                                                                                .create(speedModifier, 2), 1),
        ...
        public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super VillagerEntityMCA>>> getRestPackage(
                ...
                return ImmutableList.of(
                                ...
                                Pair.of(2, ExtendedWalkTowardsTask.create(MemoryModuleType.HOME, speed, 1, 192, 1200,
                                                (v) -> {
                                                        Optional<Boolean> memory = v.getBrain().getMemoryInternal(
                                                                        MemoryModuleTypeMCA.FORCED_HOME);
                                ...
                                Pair.of(3, new ConditionalSingleTickTask<>(
                                                ExtendedForgetCompletedPointOfInterestTask.create(
                                                                registryEntry -> registryEntry.is(PoiTypes.HOME),
                                                                MemoryModuleType.HOME, (entity) -> {
                                                                        // update villagers home/bed position
                                ...
                                Pair.of(5,
                                                new RunOne<>(ImmutableMap.of(MemoryModuleType.HOME,
                                                                MemoryStatus.VALUE_ABSENT),
                                                                ImmutableList.of(
                                                                                Pair.of(SetClosestHomeAsWalkTarget
                                                                                                .create(speed), 1),
                                                                                Pair.of(InsideBrownianWalk
                                                                                                .create(speed), 4),
                                                                                Pair.of(GoToClosestVillage.create(speed,
                                                                                                4), 2),
                                                                                Pair.of(new DoNothing(20, 40), 2)))),
                                Pair.of(99, UpdateActivityFromSchedule.create()));
        }
        ...
        public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super VillagerEntityMCA>>> getMeetPackage(
                ...
                return ImmutableList.of(
                                Pair.of(2, new RunOne<>(ImmutableList.of(
                                                Pair.of(StrollAroundPoi.create(MemoryModuleType.MEETING_POINT, 0.4F,
                                                                40), 2),
        ...
        public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super VillagerEntityMCA>>> getIdlePackage(
                ...
                return ImmutableList.of(
                                ...
                                Pair.of(2, new RunOne<>(ImmutableList.of(
                                                Pair.of(InteractWith.of(EntitiesMCA.FEMALE_VILLAGER, 8,
                                                                MemoryModuleType.INTERACTION_TARGET,
                                                                speedModifier, 2), 2),
                                                Pair.of(InteractWith.of(EntitiesMCA.MALE_VILLAGER, 8,
                                                                MemoryModuleType.INTERACTION_TARGET,
                                                                speedModifier, 2), 2),
                                                Pair.of(InteractWith.of(EntityType.CAT, 8,
                                                                MemoryModuleType.INTERACTION_TARGET, speedModifier,
                                                                2), 1),
        ...
        public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super VillagerEntityMCA>>> getPreRaidPackage(
                ...
                return ImmutableList.of(
                                ...
                                Pair.of(0, new RunOne<>(ImmutableList.of(
                                                Pair.of(SetWalkTargetFromBlockMemory.create(
                                                                MemoryModuleType.MEETING_POINT,
        ...
        private static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super VillagerEntityMCA>>> getAdventurerPackage(
                ...
                return ImmutableList.of(
                                Pair.of(5,
                                                InteractWith.of(EntitiesMCA.FEMALE_VILLAGER, 8,
                                                                MemoryModuleType.INTERACTION_TARGET,
                                                                speedModifier, 2)),
                                Pair.of(5,
                                                InteractWith.of(EntitiesMCA.MALE_VILLAGER, 8,
                                                                MemoryModuleType.INTERACTION_TARGET,
                                                                speedModifier, 2)),
                                Pair.of(5, InteractWith.of(EntityType.CAT, 8, MemoryModuleType.INTERACTION_TARGET,
                                                speedModifier, 2)),
